...
CREATE INDEX idx_leetcode_questions_topic_id ON public.leetcode_questions(topic_id);
CREATE INDEX idx_leetcode_questions_difficulty_level ON public.leetcode_questions(difficulty_level);
