  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!error) {
        ...
        navigate(`/email-verification?email=${encodeURIComponent(validatedData.email)}`);
      }
    } catch (error: any) {
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-10 bg-white/10 border-white/20 text-white placeholder-white/60 ${errors.name ? 'border-red-500' : ''}`}
                  required
                />
                {errors.name && (
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  className={`pl-10 bg-white/10 border-white/20 text-white placeholder-white/60 ${errors.confirmPassword ? 'border-red-500' : ''}`}
                  required
                />
